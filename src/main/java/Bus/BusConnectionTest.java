...
// distanceBetweenTwoZipCodes =
// Calculators.DistanceCalculatorHaversine.calculate(startLat,
// startLon,
// endLat,
// endLon);
// for (int minute = 0; minute < 30; minute++) {
// Time setDepartureTime = Time.valueOf(String.format("10:%02d:00", minute));
// bestTrip = processRoutes(conn, startLat, startLon, endLat, endLon,
// setDepartureTime);
...
// } else {
// System.out.println(
// "At " + setDepartureTime + " from " + startZip + " to " + endZip + " walk is
// better.");
// }
...
// * @throws SQLException if a database error occurs
// */
// public static void setupNearestStops(Connection conn, double startLat, double
// startLon, double endLat,
...
// conn.prepareStatement(createNearestStartStops);
...
// * @throws SQLException if a database error occurs
// */
// public static void findPotentialRoutes(Connection conn, Time
// setDepartureTime) throws SQLException {
...
// * @throws SQLException if a database error occurs
// */
// private static RouteStopInfo findRouteBusStops(Connection conn, Time
// setDepartureTime) throws SQLException {
// RouteStopInfo routes = null;
// String setGroupConcatMaxLen = "SET SESSION group_concat_max_len = 1000000;";
// String sql = "SELECT route_id, start_stop_id, end_stop_id FROM
// route_bus_stops;";
...
// stmt.execute(setGroupConcatMaxLen); // Extend group_concat_max_len for large
// datasets
...
// * @throws SQLException if a database error occurs
// */
// private static TripInfo printNextDepartureAndArrival(Connection conn, String
// routeId, String startStopId,
